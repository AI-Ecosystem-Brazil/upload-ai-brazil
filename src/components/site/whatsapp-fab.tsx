...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-24 right-4 z-[60] flex h-14 w-14 items-center justify-center rounded-full border border-primary/30 bg-surface/90 text-primary shadow-lime-glow backdrop-blur transition-transform duration-200 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background motion-reduce:transition-none motion-reduce:hover:scale-100 md:bottom-6 md:right-6"
    >
      <svg
        aria-hidden
        viewBox="0 0 24 24"
